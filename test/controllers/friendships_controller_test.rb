...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { accepted: @friendship.accepted, reciever_uid: @friendship.reciever_uid, sender_uid: @friendship.sender_uid }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { accepted: @friendship.accepted, reciever_uid: @friendship.reciever_uid, sender_uid: @friendship.sender_uid }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
